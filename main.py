...
def draw(width, height, color=200, backgroundColor=(0,0,0), perlinFactorW=2, perlinFactorH=2, step=0.001):
    ...
    p_noise = Perlin2D(width, height, perlinFactorW, perlinFactorH, clampHorizontal=True, clampVertical=True)
    ...
    # save(p, fname='myName', folder='./images', overwrite=True)

draw(3000, 2000, color=0, perlinFactorW=5, perlinFactorH=5, step=0.0005)